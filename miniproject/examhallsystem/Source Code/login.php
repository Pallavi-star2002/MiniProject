...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
             ...
             ?>
          <div class="container-fluid" style="background-image: url('uploadImage/Logo/<?php echo htmlspecialchars($row_login['background_login_image']); ?>'), url('../Source Code/uploadImage/exam.png'); background-repeat:repeat;">
